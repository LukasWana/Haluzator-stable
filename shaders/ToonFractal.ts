...
// update: Nyan Cat cameo, thanks to code from mu6k: https://www.shaderyoy.com/view/4dXGWH
...

{
    ...
    int RAY_STEPS = int(mix(50.0, 150.0, u_quality));
	...
	dir.y-=.02;
	float sunsize=6.0; // responsive sun size - replaced texture with static value
    ...
    float SATURATION = SATURATION_BASE + pow(iAudio.y, 2.0) * 0.25;
...
{
    t = iTime * (0.5 + pow(iAudio.w, 1.5) * 1.0);
